...
int main()
{
    ...
    cout << "************************************************************" << endl;
    cout << "Please enter three numerical grades ( > 0 and <= 100 )" << endl;
    for(int i = 0; i < NUMBER_OF_GRADES; i++) {      // Get 3 grades from user
/*****************************************************************************/
        do{
            cout << "Type in the student's numerical grade " << i + 1 << ": "; // Prompt user for input
